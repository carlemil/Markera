...
| 89 | Markera: label the viewfinder guide circle in the live camera preview with a 7 just inside and a 6 just outside it (user request 2026-09-15), so it is clear the green circle is meant to sit on the 6/7 ring | queued (after 88) |
