...
| 36b | Statistik screen (androidMain): Home card + `Screen.Statistics`; loads all pages; filter chips (caliber, date presets 7/30/365/alla + DateRangePicker, hits stepper); drawn target to ring 5 with hits coloured old (blue) → new (green) + legend; measurements list (mm whole numbers, score 1 decimal) | in progress |
