...
| 67 | "Are you sure" dialog on every delete: account and series deletion already confirm; add one shared `DeleteHoleDialog` for the Serie screen's per-row trash button and the scan screen's long-press hole removal (requested 2026-09-08) | queued |
| 68 | Historik rows (and the matching date/caliber header on the Serie screen): the caliber must stand out — same text size as the date and bold (requested 2026-09-08) | queued |
