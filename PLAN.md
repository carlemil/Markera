...
| 94 | Statistik: move Kaliber and Datum back below the tabs — 91 looked bad on the phone (user 2026-09-16); the state stays hoisted in StatsScreen, so the two tabs keep sharing the same filter | done 2026-09-16 — gate 187 green, iOS links |
