...
| 54 | Delete the old series without geometry (pre 2026-09-07 test data) from the production DB — user: "old series without geometry can be deleted, we dont need old test data"; no rescan path needed (requested 2026-09-07) | queued |
