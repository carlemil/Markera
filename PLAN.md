...
| 65 | Statistik chips: a selected chip must stand out clearly — today the outline on unselected chips makes them look almost selected; give selected chips a solid accent fill (and drop or fade the border on unselected ones) (requested 2026-09-08) | queued |
